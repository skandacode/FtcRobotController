...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 1.0065362173038229; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.015748031496063; // Multiplier in the Y direction
