...
@Config
@Autonomous
public class BlueFar2plus2 extends LinearOpMode
{
    OpenCvWebcam webcam;
    ...
    public void runOpMode() throws InterruptedException{
        ...
        TrajectorySequence left = drive.trajectorySequenceBuilder(new Pose2d(-36.11, 62.17, Math.toRadians(270.00)))
                ...
                .splineTo(new Vector2d(-56, 44), Math.toRadians(210))
        ...
        TrajectorySequence middle = drive.trajectorySequenceBuilder(new Pose2d(-36.11, 62.17, Math.toRadians(270.00)))
                ...
                .splineTo(new Vector2d(-9, 58), Math.toRadians(180))
                .splineTo(new Vector2d(-56, 41), Math.toRadians(216))
                //.splineTo(new Vector2d(-49, 47), Math.toRadians(216))
                .UNSTABLE_addDisplacementMarkerOffset(-20, ()->{
                    intake.intakePosition4th(0);
                    intake.setPower(1);
                })
                ...
                .waitSeconds(2)
                .build();
        TrajectorySequence right = drive.trajectorySequenceBuilder(new Pose2d(-36.11, 63, Math.toRadians(270.00)))
                ...
                .splineTo(new Vector2d(-9, 58), Math.toRadians(180))
                .splineTo(new Vector2d(-56, 41), Math.toRadians(216))
                //.splineTo(new Vector2d(-49, 48), Math.toRadians(216))
                .UNSTABLE_addDisplacementMarkerOffset(-20, ()->{
                    intake.intakePosition4th(0);
                    intake.setPower(1);
                })
                ...
                .setReversed(true)
                .splineTo(new Vector2d(-9, 58), Math.toRadians(0))
                .splineTo(new Vector2d(45.5, 39), Math.toRadians(0.00))
                .addTemporalMarker(()->{
                    outtake.setPixelLatch(false);
                })
                .UNSTABLE_addTemporalMarkerOffset(1, ()->{
