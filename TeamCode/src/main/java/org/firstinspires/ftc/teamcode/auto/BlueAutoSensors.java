...
public class BlueAutoSensors extends LinearOpMode {
    ...
    public void runOpMode()
    {
        ...
        TrajectorySequence yellowAndToStackPathLeft=drive.trajectorySequenceBuilder(new Pose2d(11.83, 62.16, Math.toRadians(270.00)))
                ...
                .back(4)
                .lineToLinearHeading(new Pose2d(47.5, 42, Math.toRadians(180.00)))
                .setReversed(false)
                ...
                .waitSeconds(2)
                .lineToSplineHeading(new Pose2d(30, 12, Math.toRadians(177)))
                .splineToConstantHeading(new Vector2d(20, 9), Math.toRadians(177))
        ...
        TrajectorySequence toStagefromStackPathLeft=drive.trajectorySequenceBuilder(yellowAndToStackPathLeft.end())
                ...
                .build();
        TrajectorySequence toStackFromStageLeft=drive.trajectorySequenceBuilder(toStagefromStackPathLeft.end())
                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(45, Math.toRadians(90), DriveConstants.TRACK_WIDTH))
                .setAccelConstraint(SampleMecanumDrive.getAccelerationConstraint(45))
                .addTemporalMarker(()->{
                    outtake.setPixelLatch(false);
        ...
        TrajectorySequence toBackdropfromStageLeft=drive.trajectorySequenceBuilder(toStagefromStackPathLeft.end())
                ...
                .waitSeconds(1)
                .build();
        TrajectorySequence toStackfromBackdropLeft=drive.trajectorySequenceBuilder(toBackdropfromStageLeft.end())
                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(45, Math.toRadians(90), DriveConstants.TRACK_WIDTH))
                .setAccelConstraint(SampleMecanumDrive.getAccelerationConstraint(45))
                .addTemporalMarker(()->{
                    outtake.transferPosition();
        ...
        TrajectorySequence yellowAndToStackPathMiddle=drive.trajectorySequenceBuilder(new Pose2d(11.83, 62.16, Math.toRadians(270.00)))
                ...
                .back(4)
                .lineToLinearHeading(new Pose2d(47.5, 34, Math.toRadians(180.00)))
                .setReversed(false)
                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(45, Math.toRadians(90), DriveConstants.TRACK_WIDTH))
                .setAccelConstraint(SampleMecanumDrive.getAccelerationConstraint(45))
                .UNSTABLE_addTemporalMarkerOffset(0.5, ()->{
